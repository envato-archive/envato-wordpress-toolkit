      ...
      if ( isset( $_GET['action'] ) ) {
        ...
        if ( empty( $errors ) ) {
          ...
          foreach( $ewpu_themes as $theme ) {
            if ( isset( $themes[$theme->theme_name] ) )
              echo 'Yes';
            $item_details = $api->item_details( $theme->item_id );  
            echo '<li>';
              echo '<div class="thumbnail"><img src="' . $item_details->thumbnail  . '" alt="' . $theme->theme_name . '" height="80" width="80" /></div>';
              echo '
              <div class="item-details">
                <h4>' . $theme->theme_name . ' ' . $theme->version . ' by ' . $theme->author_name . '</h4>
